    ...
    >
      <Tabs.Screen
        ...
        options={{
          ...
          href: hasPerm("scan") ? undefined : null,
        }}
      />
      <Tabs.Screen
        name="logs"
        options={{
          ...
          href: hasPerm("view_logs") ? undefined : null,
        }}
      />
      <Tabs.Screen
        name="comms"
        options={{
          title: t("comms"),
          tabBarIcon: ({ color }) => <MessageSquareText size={22} color={color} />,
          href: hasPerm("send_messages") ? undefined : null,
        }}
      />
