...
export const dict: Dict = {
  ...
  attendanceByDate: { ar: "الحضور حسب التاريخ", en: "Attendance by Date" },
  attendanceByCategory: { ar: "الحضور حسب الفئة", en: "Attendance by Category" },
  topAttendees: { ar: "الأكثر حضوراً", en: "Top Attendees" },
  setCompletionReport: { ar: "تقرير إتمام المجموعات", en: "Set Completion" },
  rewardDistribution: { ar: "توزيع المكافآت", en: "Reward Distribution" },
  manageAdmins: { ar: "إدارة المشرفين", en: "Manage Admins" },
  deactivate: { ar: "تعطيل", en: "Deactivate" },
  reactivate: { ar: "إعادة تفعيل", en: "Reactivate" },
  deactivated: { ar: "معطّل", en: "Deactivated" },
  ...
  subject: { ar: "الموضوع (عربي)", en: "Subject (Arabic)" },
  subjectEn: { ar: "الموضوع (إنجليزي)", en: "Subject (English)" },
  bodyAr: { ar: "نص الرسالة (عربي)", en: "Message body (Arabic)" },
  bodyEn: { ar: "نص الرسالة (إنجليزي)", en: "Message body (English)" },
  recipient: { ar: "المستلم", en: "Recipient" },
  allMembers: { ar: "جميع الأعضاء", en: "All Members" },
  specificMember: { ar: "عضو محدد", en: "Specific Member" },
